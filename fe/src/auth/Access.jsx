...
export default function Access() {
  return (
    <div className="w-full min-h-screen bg-[#FAFAFA] flex justify-center items-center px-4">
      {/* Card container */}
      <div className="relative w-full max-w-[538px] lg:w-[538px] lg:h-[574px] bg-white rounded-[26px] border border-[#D6D6D6] shadow-sm flex flex-col p-6 sm:p-8">
        ...
        <div className="flex flex-col items-start w-full sm:w-[455px] lg:ml-[8px]">
          ...
          <img
            src={logo}
            alt="Logo"
            className="w-[180px] sm:w-[232px] h-auto object-contain mt-2 sm:mt-4"
          />
