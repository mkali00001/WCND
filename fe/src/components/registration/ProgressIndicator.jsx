const ProgressIndicator = ({ currentStep, isCompleted }) => {
    return (
        <div className="mb-[96px] mt-[112px] ">
            <div className="relative  h-[32px]">
                ...
                {[1, 2, 3, 4, 5].map((step) => (
                    <div
                        key={step}
                        className={`absolute top-1/2 w-8 h-8 rounded-full flex items-center justify-center -translate-y-1/2
              ${isCompleted || step < currentStep
                    ...
                    >
                        {isCompleted || step < currentStep ? (
                            ...
                            <div className="w-2.5 h-2.5 bg-[#972620] rounded-full"></div>
                        ) : (
                            ""
                        )}
                    </div>
