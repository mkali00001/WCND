const Step5 = ({ formData, handleInputChange }) => {
  return (
    <div className="space-y-6">
      <h2 className="text-xl font-semibold text-[#972620] mb-6">Submit & Payment</h2>
      ...
      <div>
        ...
        <textarea
          ...
          onChange={(e) => handleInputChange("finalMessage", e.target.value)}
          rows={6}
      ...
      <div className="space-y-4">
        <label className="flex items-start space-x-3">
          <input
            ...
            onChange={(e) => handleInputChange("finalConfirmation", e.target.checked)}
